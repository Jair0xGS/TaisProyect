...
class IndicadorController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('indicador.index')->with('datos', '¡Registro actualizado con éxito!');
    }
    ...
    public function destroy($id)
    {
        try {
            ...
            return redirect()->route('indicador.index')->with('datos', '¡ERROR: La empresa que quiere eliminar está en uso!');
        }
    }
}
