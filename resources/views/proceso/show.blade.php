                        ...
                        <table class="table mb-5">
                            ...
                            @foreach($data->procesos as $elem)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        {{$elem->personal->nombre}}
                                    </td>
                                    <td>
                                        {{$elem->personal->puesto->nombre}}
                                    </td>
                                    <td>
                                        <a href="{{route('subproceso.show',[Request()->empresa,$data->id,$elem->id])}}" class="btn btn-success" role="button" aria-pressed="true">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-eye-fill" viewBox="0 0 16 16">
                                                <path d="M10.5 8a2.5 2.5 0 1 1-5 0 2.5 2.5 0 0 1 5 0z"/>
                                                <path d="M0 8s3-5.5 8-5.5S16 8 16 8s-3 5.5-8 5.5S0 8 0 8zm8 3.5a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7z"/>
                                            </svg>
                                        </a>
                                        @if($elem->user_id == \Illuminate\Support\Facades\Auth::id())
                                            @if($elem->detalles->count()==0)
                                                <a href="{{route('proceso.edit',$elem->id)}}" class="btn btn-primary" role="button" aria-pressed="true">
                                                ...
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            {!! Form::open(['action' => ['ProcesoController@destroy',$elem->id],'method'=>'POST']) !!}
