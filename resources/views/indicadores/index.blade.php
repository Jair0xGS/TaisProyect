...
@section('contenido')
    ...
    <div style="margin-left: 150px;margin-right: 150px">
        ...
        @if(count($proceso)>0)
                    ...
                    <tr>
                        <td @if(count($itemProceso->procesos)==0) rowspan="1" @else rowspan="{{count($itemProceso->procesos)}}" @endif>
                            {{$itemProceso->nombre}}
                        </td>
                        <td @if(count($itemProceso->procesos)==0) rowspan="1" @else rowspan="{{count($itemProceso->procesos)}}" @endif>
                            ...
                            @else
                                @foreach($item->indicadores as $itm)
                                    ...
                                    <td>
                                        ...
                                        <!-- Modal -->
                                        <form method="POST" action="{{route("indicador.destroy",$itemProceso->id)}}">
                                            @method('delete')
                                            @csrf
