...
@section('contenido')
    ...
    <div class="container">
        <div class="row ">
            <a href="{{route('indicador.index')}}" class="btn btn-dark" role="button" aria-pressed="true">
        ...
        <div class="row justify-content-center ">
            ...
            <div class="row">
                ...
                <div class="col-6 ">
                    {!! Form::open(['action' => ['TableroController@store',Request()->indicador],'method'=>'POST']) !!}
                    ...
                    <div class="form-group">
                        ...
                        {{Form::select('frecuencia',[
                            "Mensual"=>"Mensual",
                            "Anual"=>"Anual"
                            ],null,['class'=> eClass( $errors->getBag('default')->first('frecuencia')),'placeholder'=>'Frecuencia'])}}
                ...
                <div class="col-6 ">
                    <div class="form-group">
                        {{Form::label('iniciativas','Iniciativas')}}
                            {{Form::textarea('iniciativas',null,['class'=> eClass( $errors->getBag('default')->first('iniciativas')),'placeholder'=>'Iniciativas',"rows"=>"2"])}}
                        <div class="invalid-feedback">
